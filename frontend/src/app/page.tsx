...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-[#0A0F1C] selection:bg-blue-500/30 selection:text-blue-200">
      {/* Navigation */}
      <header className="px-6 lg:px-12 h-20 flex items-center border-b border-white/5 backdrop-blur-xl bg-[#0A0F1C]/80 sticky top-0 z-50">
        ...
        <nav className="ml-auto flex gap-6 items-center">
          ...
          <Link href="/signup">
            <Button className="bg-blue-600 hover:bg-blue-500 text-white rounded-full px-6 shadow-[0_0_15px_rgba(59,130,246,0.2)] transition-all hover:shadow-[0_0_25px_rgba(59,130,246,0.4)]">
              Get Started
            </Button>
          </Link>
        </nav>
      ...
      <main className="flex-1 flex flex-col items-center relative overflow-hidden">
        ...
        <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-blue-600/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <section className="w-full pt-32 pb-24 md:pt-40 md:pb-32 flex justify-center text-center px-4 relative z-10">
          ...
          >
            <motion.div variants={fadeUp} className="inline-flex items-center rounded-full border border-blue-500/20 bg-blue-500/10 px-4 py-1.5 text-sm font-medium text-blue-400 backdrop-blur-md">
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8 w-full sm:w-auto">
              <Link href="/signup" className="w-full sm:w-auto">
                <Button size="lg" className="h-14 px-8 bg-blue-600 hover:bg-blue-500 text-white rounded-full text-base font-medium w-full shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all hover:scale-105">
            ...
            >
              {[
                ...
                <motion.div 
                  key={i}
                  variants={fadeUp}
                  className="flex flex-col space-y-4 p-8 rounded-3xl bg-[#161F32]/50 border border-white/5 backdrop-blur-xl hover:bg-[#161F32] transition-colors"
                >
                  <div className="h-12 w-12 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-2">
      ...
      <footer className="py-8 w-full border-t border-white/5 flex items-center justify-center bg-[#0A0F1C]">
